...
<title>FreeSlots.com - Candy Store</title>
<meta name="description" content="Play the most realistic slots! More than 25 FREE slots with large smoothly animated reels and lifelike slot machine sounds.">
...
<body bgcolor="#000000" text="#0099FF" link="#00AAFF" vlink="#00AAFF" alink="#0088CC" monica-id="ofpnmcalabcbjgholdjcjblkibolbppb" monica-version="7.9.7">
<div align="center">
...
<div id="homebutton" class="homebutton" style="margin-right: 959px;">
<a href="//www.freeslots.com/" target="_top" onclick="return onHomeButton();">
...
<div class="row">
<div id="game" align="left" style="margin-left: 1px;">
  <canvas id="canvas" width="1174" height="775" style="width: 939px; height: 620px;"></canvas>
  <img id="paytable" src="/images502/sign.png" style="height: 457px; width: 939px;">
  <img id="tray" src="/5reel/tray.png" style="height: 262px; width: 939px;">
</div><div id="right" align="left" style="margin-top: 239px;">
</div>
</div>
...
<div id="progressbar" class="ui-progressbar ui-widget ui-widget-content ui-corner-all" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="100" style="position: absolute; top: 262px; left: 50%; width: 210px; margin-left: -105px; height: 13px; border-radius: 8px; margin-top: -7px; display: none;">
...
<script type="text/javascript" src="/slot502.min.js?v=98"></script>
